...
<span id="myresults" class="my-results">Your Score : {{$score}}</span><br><br>
...
<ul class="quiz">
  ...
  <li>  
     @php(\array_splice($choosenOps, 0, 1))
