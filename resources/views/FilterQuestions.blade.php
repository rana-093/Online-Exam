...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="flex-center position-ref full-height">
            ...
            @endif
            <form style="width:50%;" action="{{ url('/FilterQBank') }}" method="post">  
              @csrf
            <div  style="width:80%; padding:10%;margin:10%;" class="panel panel-primary">
<!--  <form action="{{url('/myexams')}}"> -->
    <div class="panel-heading">Filter Question Bank</div>
      <div >
         <div class="row">
      ...
      <div class="form-group">
         ...
         <input type="text" class="form-control" name="subject" id="fname"placeholder="Enter...">
      </div>
